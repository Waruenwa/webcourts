...
export const metadata = {
  title: 'COURTS | รวมลดปลดหนี้ วิเคราะห์ภาระหนี้ ปรึกษาปัญหาหนี้ ฟรี',
  description:
    'COURTS บริษัทผู้เชี่ยวชาญด้านการรวมลดปลดหนี้ วิเคราะห์ภาระหนี้ ให้คำปรึกษาปัญหาหนี้ครบวงจร แก้ไขหนี้อย่างถูกกฎหมาย ช่วยลดภาระหนี้สิน ปรึกษาฟรี ไม่มีค่าใช้จ่าย',
  keywords: [
    'รวมลดปลดหนี้',
    'วิเคราะห์ภาระหนี้',
    'ปรึกษาปัญหาหนี้',
